...
x <- runif(1, 0, 10) # give us random number between 0 and 10
x
if (x > 5) {
...
```{r}
# sets i equal to that number and then prints it
for (i in 1:5) {
     print(i)
}
```
...
grade_tags<- character(length(grades))
...
for (i in 1:length(numbers)) {
  cumulative_product <- cumulative_product * numbers[i]
}

print(paste("Final cumulative product:", cumulative_product))
